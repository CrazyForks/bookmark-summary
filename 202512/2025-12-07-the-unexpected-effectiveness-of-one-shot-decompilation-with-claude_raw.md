...
URL Source: https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/

Published Time: 2025-11-27T13:48:07-05:00

Markdown Content:
Recently, I’ve been experimenting with ‘one-shot’ decompilation, leveraging Claude’s [headless mode](https://code.claude.com/docs/en/headless) in a continuous loop.[1](https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/#fn:1) The results have been surprisingly positive. In the three weeks since adopting this workflow, I’ve made more progress on [Snowboard Kids 2](https://github.com/cdlewis/snowboardkids2-decomp) than in the preceding three months.[2](https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/#fn:2)

![Image 1: chart showing recent decompilation progress](https://blog.chrislewis.au/sbk2-progress.svg#darksafe)
...
![Image 2: diagram showing decompilation workflow](https://blog.chrislewis.au/workflow.svg#darksafe)
...
![Image 3: diagram showing decompilation workflow](https://blog.chrislewis.au/scorer-comparison.webp#darksafe)
...
![Image 4: histogram of functions bucketed by estimated difficulty](https://blog.chrislewis.au/difficulty-distribution.svg#darksafe)
...
_If you’ve made it this far, you probably have an interest in decompilation and Snowboard Kids. Give it a try. Take a look at [difficult\_functions](https://github.com/cdlewis/snowboardkids2-decomp/blob/main/tools/difficult\_functions) on the [Snowboard Kids 2 decomp GitHub page](https://github.com/cdlewis/snowboardkids2-decomp) and see if you can beat the LLMs!_

_Something to say? You can upvote and/or join [the discussion on Hacker News](https://news.ycombinator.com/item?id=46080498)._

* * *

1.   Inspired by Anand Chowdhary’s post on [running Claude Code in a loop](https://anandchowdhary.com/blog/2025/running-claude-code-in-a-loop).[↩︎](https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/#fnref:1)

2.   Progress is currently tracked on [decomp.dev](https://decomp.dev/cdlewis/snowboardkids2-decomp?mode=history). Before then, the [README.md](https://github.com/cdlewis/snowboardkids2-decomp/commit/f34cdb1c26ef64cd4627980d4f8753abe11f03c2) file was directly updated to reflect progress.[↩︎](https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/#fnref:2)

3.   This is borne out in the data although the connection is not as strong as I had originally anticipated. 62.7% of calls flow from higher complexity to lower complexity functions.[↩︎](https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/#fnref:3)

4.   Why didn’t I update the prompt to reflect this? Because it made Claude confused and it stopped committing changes. LLMs are weird. This needs more experimentation.[↩︎](https://blog.chrislewis.au/the-unexpected-effectiveness-of-one-shot-decompilation-with-claude/#fnref:4)