...
URL Source: https://lucumr.pocoo.org/2025/12/17/what-is-plan-mode/

Published Time: 2025-12-17T00:00:00
...
Because plan mode is also a tool (or at least the entering and exiting plan mode is), the agent can enter it itself. This has the same effect as if you were to press shift+tab. [1](https://lucumr.pocoo.org/2025/12/17/what-is-plan-mode/#fn-1)
...
1.   This incidentally is also why it’s possible for the plan mode confirmation screen to come up with an error message, that [there is no plan](https://x.com/mitsuhiko/status/1997983563891818736) unprompted.[↩](https://lucumr.pocoo.org/2025/12/17/what-is-plan-mode/#fnref-1)

This entry was tagged [ai](https://lucumr.pocoo.org/tags/ai/)

[copy as](https://lucumr.pocoo.org/2025/12/17/what-is-plan-mode.md) / [view](https://lucumr.pocoo.org/2025/12/17/what-is-plan-mode.md) markdown
